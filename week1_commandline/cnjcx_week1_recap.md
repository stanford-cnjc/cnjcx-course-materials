...
```bash
$ cd ~/cncjx
$ curl -L -o basic_vimrc https://raw.githubusercontent.com/stanford-cnjc/cnjcx-course-materials/blob/master/week2_tmux_vim/dot_files/basic_vimrc
$ curl -L -o basic_tmux.conf https://raw.githubusercontent.com/stanford-cnjc/cnjcx-course-materials/blob/master/week2_tmux_vim/dot_files/basic_tmux.conf
```
